...
const timeInterval = require('../other/timeInterval');

//  Что бы получить к-ство свечей в дней, посчитал сколько секунд в сутках
//  и разделил на секунды в 1 свече
const quantityCandlesInOneDay = 24 * 60 * 60 / (timeInterval.timeOneCandleMiliseconds/1000);

let needCycle = Math.floor((quantityCandlesInOneDay * initData.testDayHistoryCandles) / initData.quantityCandles);
