...
function testPlaceOrder(signal, price, date) {
	...
	if (signal == 'short') {
		...
		if (activeFundsFirstCoin > 0) {
			...
			// console.log(`activeFundsFirstCoin coins: ${initData.firstCoin} ${activeFundsFirstCoin}`);
			// console.log(`activeFundsSecondCoin coins: ${initData.secondCoin} ${activeFundsSecondCoin}`);
		...
		// console.log(`Total coins: ${initData.firstCoin} ${quantityFirstCoinInWallet}`);
